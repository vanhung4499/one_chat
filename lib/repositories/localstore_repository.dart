...
import 'package:one_chat/models/settings.dart';
...
class LocalStoreRepository extends GetxService {
  ...
  final String _promptsKey = 'prompts';
  ...
  String getPromptsJsonString() {
    String jsonStr = '';
    if (store.hasData(_promptsKey)) {
      jsonStr = store.read(_promptsKey);
    }
    return jsonStr;
  }

  savePrompts(String jsonStr) {
    store.write(_promptsKey, jsonStr);
  }
