...
import 'package:one_chat/models/bottom_switcher.dart';
...
import 'package:one_chat/widgets/settings/grouped_bottom_sheet_switcher_widget.dart';
...
class ChatEditPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GetBuilder<ChatSessionEditController>(builder: (controller) {
          return ListView(
  ...
  List<Widget> buildFormList(
    ...
    widgets.add(GroupedBottomSheetSwitcherWidget(
        title: 'Model',
