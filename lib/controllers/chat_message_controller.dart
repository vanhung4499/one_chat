...
import 'package:one_chat/services/openai_service.dart';
...
class ChatMessageController extends GetxController {
  ...
  SettingsServerController settingServerController = Get.find();
  ...
  void replyFromOpenAIWithSSE(MessageModel input, String sid,
    ...
    String url =
    settingServerController.defaultServer.getRequestURLByModel(model);
    // url = "https://api2.fucklina.com/v1/chat/completions";
    Map<String, String> headers =
    settingServerController.defaultServer.getRequestHeaders(model);
